...
const payMethods = [
  { id: "cash" as const, label: "Cash", labelBn: "নগদ", icon: Banknote, color: "#059669" },
  { id: "bkash" as const, label: "bKash", labelBn: "বিকাশ", icon: Smartphone, color: "#E91E8C" },
  { id: "nagad" as const, label: "Nagad", labelBn: "নগদ", icon: Smartphone, color: "#F57C00" },
  { id: "card" as const, label: "Card", labelBn: "কার্ড", icon: CreditCard, color: "#2563EB" },
    ...
    <div className="h-screen bg-nv-50 flex flex-col overflow-hidden select-none">
      ...
      {view === "success" && (
        <div className="absolute inset-0 z-50 bg-white flex flex-col items-center justify-center p-6 text-center animate-in zoom-in-95">
          <div className="w-20 h-20 bg-em-100 rounded-full flex items-center justify-center mb-4 text-em-700 shadow-sm">
          ...
          <div className="flex flex-col gap-2.5 w-full max-w-xs">
            ...
            <button
              ...
              className="w-full py-3 bg-nv-100 hover:bg-nv-200 text-nv-800 rounded-2xl text-sm font-bold"
            >
          ...
          <div className="sidebar-gradient px-4 pt-6 pb-4 flex-shrink-0 text-white shadow-md">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-2.5 rounded-xl bg-white text-nv-900 placeholder:text-nv-400 text-xs focus:outline-none"
              />
            </div>
          </div>
        ...
        <>
          ...
          <div className="p-4 bg-white border-t border-nv-200 space-y-3">
            ...
            <button
              ...
              className="w-full py-4 bg-em-700 text-white rounded-2xl font-bold text-base shadow-lg shadow-em-900/30"
            >
      ...
      {view === "payment" && (
        <>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            <div>
              <p className="text-xs font-bold text-nv-500 uppercase tracking-wider mb-2">{isBn ? "পদ্ধতি নির্বাচন" : "Select Payment Method"}</p>
                ...
                {payMethods.map(m => (
                  <button
                    ...
                    className={`py-3 rounded-2xl flex flex-col items-center gap-1 text-xs font-bold border-2 transition-all
                      ${payment === m.id ? "border-transparent text-white shadow-md scale-102" : "border-nv-200 bg-white text-nv-700"}`}
            ...
            {payment === "cash" && (
              <div className="bg-white rounded-2xl p-4 border border-nv-200 space-y-2">
                <label className="text-xs font-semibold text-nv-700">{isBn ? "নগদ গৃহীত টাকা" : "Cash Given"}</label>
                <input
                  type="number"
                  value={cashGiven}
          ...
          <div className="p-4 bg-white border-t border-nv-200">
            <button
              ...
              className="w-full py-4 bg-gradient-to-r from-em-600 to-em-500 text-white rounded-2xl font-bold text-base shadow-xl shadow-em-900/30 flex items-center justify-center gap-2"
            >
              <CheckCircle size={20} />
