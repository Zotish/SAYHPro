...
const defaultConversations: Conversation[] = [
  // 1. Customers
  {
    ...
    roleOrTagBn: "ভিআইপি গ্রাহক",
    avatar: "RC",
    online: true,
    unreadCount: 2,
    lastMessage: "Is the fresh 5L mustard oil in stock today?",
    lastMessageTime: "10:45 AM",
    channel: "whatsapp",
    messages: [
      { id: "m1", sender: "them", text: "Hello, do you have fresh mustard oil 5L available?", time: "10:40 AM", status: "read", channel: "whatsapp" },
      { id: "m2", sender: "me", text: "Yes Rahim bhai, Radhuni and Teer 5L mustard oil both arrived today!", time: "10:42 AM", status: "read", channel: "whatsapp" },
      { id: "m3", sender: "them", text: "Great! Please keep 1 jar reserved for me, will pick up in evening.", time: "10:45 AM", status: "read", channel: "whatsapp" },
    ]
  },
  {
    id: "conv-c2",
    ...
    roleOrTagBn: "বাকিদার গ্রাহক",
    avatar: "KA",
    online: false,
    unreadCount: 0,
    lastMessage: "I will clear the ৳14,500 due via bKash by tomorrow.",
    lastMessageTime: "Yesterday",
    channel: "sms",
    messages: [
      { id: "m11", sender: "me", text: "Dear Karim Ahmed, your store ledger shows pending balance of ৳14,500.", time: "Yesterday, 3:00 PM", status: "read", channel: "sms", attachment: { type: "receipt", title: "Due Ledger Statement", amount: 14500 } },
      { id: "m12", sender: "them", text: "Received it. I will clear the ৳14,500 due via bKash by tomorrow.", time: "Yesterday, 3:20 PM", status: "read", channel: "sms" },
    ]
  },
  {
    id: "conv-c3",
    ...
    roleOrTagBn: "নিয়মিত গ্রাহক",
    avatar: "NI",
    online: true,
    unreadCount: 0,
    lastMessage: "Thanks for delivering quickly!",
    lastMessageTime: "2 days ago",
    channel: "chat",
    messages: [
      { id: "m21", sender: "me", text: "Your parcel has been handed to Steadfast courier. Tracking: SF-9941", time: "2 days ago", status: "read", channel: "chat", attachment: { type: "invoice", title: "Invoice #INV-1002", amount: 3200 } },
      { id: "m22", sender: "them", text: "Thanks for delivering quickly!", time: "2 days ago", status: "read", channel: "chat" }
    ]
  },
  ...
  // 2. Suppliers
  {
    id: "conv-s1",
    type: "supplier",
    name: "Pran-RFL Group (Distributor)",
    nameBn: "প্রাণ-আরএফএল গ্রুপ (ডিস্ট্রিবিউটর)",
    phone: "01730-001122",
    roleOrTag: "Primary Supplier",
    roleOrTagBn: "প্রধান সাপ্লায়ার",
    avatar: "PR",
    online: true,
    unreadCount: 1,
    lastMessage: "Order dispatched with van today at 2 PM.",
    lastMessageTime: "11:15 AM",
    channel: "chat",
    messages: [
      { id: "s1", sender: "me", text: "Salam, please confirm PO for 20 cartons Frooto and 10 sacks sugar.", time: "Yesterday", status: "read", channel: "chat", attachment: { type: "order", title: "Purchase Order #PO-882", amount: 48500 } },
      { id: "s2", sender: "them", text: "Salam! Order confirmed. Order dispatched with van today at 2 PM.", time: "11:15 AM", status: "read", channel: "chat" }
    ]
  },
  {
    id: "conv-s2",
    type: "supplier",
    name: "Square Consumer Products",
    nameBn: "স্কয়ার কনজিউমার প্রোডাক্টস",
    phone: "01755-998877",
    roleOrTag: "FMCG Supplier",
    roleOrTagBn: "এফএমসিজি সাপ্লায়ার",
    avatar: "SQ",
    online: false,
    unreadCount: 0,
    lastMessage: "Updated wholesale price list for Radhuni Spices attached.",
    lastMessageTime: "3 days ago",
    channel: "whatsapp",
    messages: [
      { id: "sq1", sender: "them", text: "Updated wholesale price list for Radhuni Spices attached.", time: "3 days ago", status: "read", channel: "whatsapp" }
    ]
  },
  ...
  // 3. Team & Others
  {
    id: "conv-o1",
    type: "other",
    name: "Tanvir Hossain (Cashier)",
    nameBn: "তানভীর হোসেন (ক্যাশিয়ার)",
    phone: "01844-112233",
    roleOrTag: "Store Staff",
    roleOrTagBn: "দোকানের স্টাফ",
    avatar: "TH",
    online: true,
    unreadCount: 0,
    ...
    channel: "chat",
    messages: [
      { id: "o1", sender: "them", text: "Closing cash count matched with system POS. Total cash in drawer: ৳42,350.", time: "Yesterday, 10:15 PM", status: "read", channel: "chat" },
      { id: "o2", sender: "me", text: "Well done Tanvir, lock the safe.", time: "Yesterday, 10:20 PM", status: "read", channel: "chat" }
    ]
  },
  {
    id: "conv-o2",
    type: "other",
    name: "Steadfast Courier Support",
    nameBn: "স্টেডফাস্ট কুরিয়ার সাপোর্ট",
    phone: "09678-000999",
    roleOrTag: "Delivery Partner",
    roleOrTagBn: "ডেলিভারি পার্টনার",
    avatar: "SF",
    online: true,
    unreadCount: 0,
